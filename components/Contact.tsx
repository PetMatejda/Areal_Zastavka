      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-start">
        ...
        >
          ...
          <div className="flex flex-col gap-5">
            {[
              { icon: '📍', label: 'Adresa', val: 'Za Zástávkou 377/3, 109 00 Praha-Dolní Měcholupy' },
              { icon: '📞', label: 'Telefon', val: '+420 603 233 264' },
              { icon: '✉️', label: 'Email', val: 'info@arealzastavka.cz' },
            ].map((c, i) => (
              <div key={i} className="flex gap-4 items-start">
                <div className="w-10 h-10 rounded-lg bg-[var(--surface2)] border border-[var(--border)] flex items-center justify-center text-lg flex-shrink-0">
                  {c.icon}
                </div>
                <div>
        ...
        >
          <div className="w-16 h-16 rounded-xl bg-[var(--accent)]/10 border border-[var(--accent)]/20 flex items-center justify-center text-3xl mb-6">
            👋
          </div>
          ...
          <div className="flex gap-3 flex-wrap justify-center w-full">
            <a href="tel:+420603233264" className="w-full sm:w-auto text-center bg-[var(--accent)] hover:bg-[var(--accent-light)] transition-all text-white font-sans text-sm font-semibold px-6 py-3.5 rounded-lg transform hover:-translate-y-0.5 shadow-lg">
              📞 Zavolat nyní
            </a>
            <a href="mailto:info@arealzastavka.cz" className="w-full sm:w-auto text-center bg-transparent border border-[var(--border)] hover:border-white/30 hover:text-white transition-all text-[var(--text)] font-sans text-sm font-medium px-6 py-3.5 rounded-lg backdrop-blur-md">
              ✉️ Napsat e-mail
            </a>
          </div>
        </motion.div>
