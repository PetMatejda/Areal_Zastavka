      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="glass rounded-2xl p-8 md:p-12 shadow-xl inline-block max-w-4xl border border-white/20 relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-blue-50/20 via-white/10 to-orange-50/20 opacity-30"></div>
          ...
          {valuePropositions.map((prop, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-blue-50/0 via-blue-50/0 to-orange-50/0 group-hover:from-blue-50/15 group-hover:via-white/10 group-hover:to-orange-50/15 transition-all duration-500"></div>
                <div className="relative z-10">
